            ...
            <div class="flex shadow-md my-10">
                <div class="w-3/4 bg-white px-10 py-10">
                    ...
                    <div class="flex mt-10 mb-5">
                        ...
                        <h3 class="font-semibold text-gray-600 text-xs uppercase w-1/5 text-center">Price(U)</h3>
                    ...
                    <div v-for="cart in cartBox" :key="cart.id">
                        <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                            ...
                            <div class="flex justify-center w-1/5">
                                <span class="text-center w-1/5 font-semibold text-sm">{{ cart.qty }}</span>
                            </div>
                    ...
                    <a href="#" class="flex font-semibold text-orange-500 text-sm mt-10">
                        <svg class="fill-current mr-2 text-orange-500 w-4" viewBox="0 0 448 512">
                            <path
                ...
                <div id="summary" class="w-1/4 px-8 py-10">
                    ...
                    <button class="bg-orange-500 hover:bg-orange-700 px-5 py-2 text-sm rounded-lg text-white uppercase">
                        Apply
                    </button>
                    <div class="border-t mt-8">
                        ...
                        <Link :href="route('checkout.index')"
                            class="bg-orange-500 hover:bg-orange-700 px-5 py-3 text-sm rounded-lg text-white uppercase">
                            Checkout
                        </Link>
                    </div>
                </div>
