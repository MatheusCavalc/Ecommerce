                    ...
                    <div class="flex shadow-md">
                        <div class="w-3/4 bg-white px-10 py-10">
                            ...
                            <div class="flex mt-10 mb-5">
                                ...
                                <h3 class="font-semibold text-gray-600 text-xs uppercase w-1/5 text-center">Price(U)
                                </h3>
                            ...
                            <a href="#" class="flex font-semibold text-orange-500 text-sm mt-10">
                                ...
                                <Link
                                    class="bg-orange-500 hover:bg-orange-700 px-5 py-2 text-sm rounded-lg text-white uppercase">
                                Continue Shopping
                                </Link>
                            </a>
                            -->
